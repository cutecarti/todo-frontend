import { createContext, useState, useRef, useCallback, useEffect, useMemo, useReducer } from "react";
...
const useTasks = () => {
    ...
    useEffect(()=>{
        ...
        tasksAPI.getAll().then((taskResp) => {dispatch({type: "SET_ALL", tasks: taskResp})})
    },[])
